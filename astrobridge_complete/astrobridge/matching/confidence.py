...
class ConfidenceScorer:
    ...
    def compute_score(
        ...
        """
        # Auto-compute separation if not provided
        if separation_arcsec is None:
            from astrobridge.geometry import angular_distance_arcsec as _sep
            separation_arcsec = _sep(
                source1.coordinate.ra, source1.coordinate.dec,
                source2.coordinate.ra, source2.coordinate.dec
            )
